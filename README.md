...
| 🐧 Linux | ARM64 | [**kafkaguard_Linux_arm64.tar.gz**](https://github.com/KafkaGuard/kafkaguard-releases/releases/latest/download/kafkaguard_Linux_arm64.tar.gz) |
...
```bash
# Download checksums (replace VERSION with your version, e.g. 2.0.0)
curl -LO https://github.com/KafkaGuard/kafkaguard-releases/releases/latest/download/kafkaguard_2.0.0_checksums.txt

# Verify
sha256sum -c kafkaguard_2.0.0_checksums.txt
```
...
│                                                                      │
└──────────────────────────────────────────────────────────────────────┘
  Generated by KafkaGuard v2.0.0
```
...
© 2025-2026 KafkaGuard. All rights reserved.
